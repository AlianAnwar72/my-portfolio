...
const Hero = () => (
  <section
    id="home"
    className="relative flex flex-col items-center justify-center min-h-[80vh] py-20 px-4 bg-gradient-to-br from-primary/10 via-secondary/10 to-background overflow-hidden"
  >
    ...
    >
      ...
      <img
        src={profileImage}
        alt="Alian Anwar"
        className="w-36 h-36 md:w-44 md:h-44 lg:w-55 lg:h-55 rounded-full border-4 border-white shadow-2xl object-cover relative z-10"
      />
    </motion.div>
    ...
    >
      I build beautiful, scalable web applications and love turning ideas into
      reality with code.
    </motion.p>

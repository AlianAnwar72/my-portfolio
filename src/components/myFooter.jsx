...
const socialLinks = [
  { icon: <FaFacebookF />, url: 'https://www.facebook.com/alian.anwar.1/', label: 'Facebook' },
  { icon: <FaGithub />, url: 'https://github.com/AlianAnwar72', label: 'GitHub' },
  { icon: <FaLinkedinIn />, url: 'https://www.linkedin.com/in/aliananwar72/', label: 'LinkedIn' },
  { icon: <FaEnvelope />, url: 'mailto:rajaalyan977@gmail.com', label: 'Email' },
];
    ...
    <footer className="w-full px-4 py-10 mt-10 bg-white/70 dark:bg-dark/70 backdrop-blur-lg rounded-t-3xl shadow-2xl border-t border-muted/30">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="text-center text-sm text-muted font-medium">
          © {new Date().getFullYear()} Alian Anwar. All rights reserved.
        </div>
      </div>
    </footer>
  );
